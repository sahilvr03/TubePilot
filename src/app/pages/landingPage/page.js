...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden">
      ...
      {/* Particle Background */}
      <div id="particles-js" className="absolute w-full h-full z-0 opacity-90" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                We design high-performance SaaS, intelligent assistants, mobile apps, and IoT
                solutions—built with cutting-edge AI and stunning user experiences.
              </p>
...
>
  Book a Demo
            ...
            >
              ...
              >
                {["AI Assistants", "E-commerce APIs", "Mobile SDKs", "IoT Platforms", "Cloud Services"].map(
                  (tech) => (
                    <span
                      key={tech}
